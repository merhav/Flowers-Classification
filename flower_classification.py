...
classes = 5
flower_path = "C:\\Users\\alina\\Documents\\semester 6\\preparation to project\\Ass2\\flowers\\flowers"
...
model_hist = model.fit_generator(train_gen, steps_per_epoch=t_steps, epochs=70, validation_data=valid_gen, validation_steps=v_steps)
